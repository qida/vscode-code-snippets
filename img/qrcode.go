...
func CreateQrcode() {
	qrcode, _ := NewQrcode("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx20935cecb1503fa2&redirect_uri=http://wechat.zxjy.work/qrcode?id_order_lesson=9637&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect", ".jpg")
	qrcode.OutQrcode("out_qrcode.jpg")
}
